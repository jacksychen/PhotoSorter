...
private let _photoSorterUIBundle: Bundle = {
    let bundleName = "PhotoSorterApp_PhotoSorterUI"
...
extension Foundation.Bundle {
    /// Resource bundle for the PhotoSorterUI target, safe for `.app` bundles.
    static var appResources: Bundle { _photoSorterUIBundle }
}
