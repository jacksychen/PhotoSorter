"""Tests for photosorter.app.pipeline_runner."""
...
from photosorter.app.pipeline_runner import (
    STEPS,
    StepInfo,
...
class TestRunPipelineWithProgress:
    ...
    def test_no_images_raises(self, tmp_path, monkeypatch):
        import photosorter.app.pipeline_runner as runner_mod
    ...
    def test_happy_path_reports_all_steps(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            lambda p, l: [
                OrderedPhoto(0, 0, p[0], 0),
                OrderedPhoto(1, 1, p[1], 1),
            ],
        )
    ...
    def test_skipped_images_filters_paths(self, tmp_path, monkeypatch):
        ...
        def fake_build_ordered_sequence(paths, labels):
            ...
            return [
                OrderedPhoto(0, 0, paths[0], 0),
                OrderedPhoto(1, 1, paths[1], 1),
            ]
